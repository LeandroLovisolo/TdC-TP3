...
Se modificó el stack PTC provisto por la cátedra de manera de poder demorar el envío de ACKs y de simular la pérdida de los mismos según un tiempo de demora y una probabilidad de pérdida especificadas al momento de crear un socket PTC.
